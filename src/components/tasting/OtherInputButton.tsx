...
export default function OtherInputButton({ label, savedValue, onSave }: OtherInputButtonProps) {
	...
	return (
		<div className="other-input">
			{savedValue ? (
				<button className="rounded quiet selected" onClick={() => setShowInput(true)} title="Click to edit">
					{savedValue} ✎
				</button>
			) : (
