...
export default function TastingPageHeader({ wineType, timerPage, timerDestination, cancelHref }: TastingPageHeaderProps) {
  ...
  return (
    <header className={`tasting-page-header${showTimer ? "" : " tasting-page-header--no-timer"}`}>
      ...
      <div className="tasting-page-header__right">
        {cancelHref ? (
          <Link href={cancelHref} className="tasting-page-header__cancel">Cancel</Link>
        ) : (
          <>
            {wineLabel && (
